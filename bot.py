...
# قائمة الكلمات لـ 30 يومًا (بدون النص الأساسي)
WORDS = [
    "رَمَضَانُ شَهْرُ الإحْسَانِ! مَثَلُهُ كَالأمِّ؛ لاَ يَصُدُّ عَنْ أَبْنَائِهَا الْتَّحْنَانَ عُقُوْقٌ وَلاَ افْتِتَانٌ",  # اليوم 1
    "رَمَضَان: شَهْرُ الاسْتِهَامِ وَالتَّعَاوُنِ فِي البِرِّ وَتَقْوَى الرَّحْمَن",  # اليوم 2
    "المُفْلِحُوْنَ فِي رَمَضَانَ: الذِيْنَ يَتَعَرَّضُوْنَ فِيْهِ لِلْرَّحْمَةِ وَالْمَغْفِرَةِ وَالْعِتْقِ مِنَ الْنِّيْرَان. وَالخَاسِرُوْنَ فِي رَمَضَانَ: الْذِيْن يَسْتَقْبِلُوْنَهُ بِوَسَائِلِ الشَّيْطَان، وَيُحْيُوْنَهُ بِالْمُنْكَرَاتِ وَالْعُدْوَان",  # اليوم 3
    "أيُّها المُسْلِمُون، هَذا شَهْر رَمَضانَ يُظِلّكم بنِعَمِه المُبارَكة، فاجْتَهِدُوا في اسْتِقْباله وإحْيائه بالمَعْرُوف إفْرادًا ومُشاركة",  # اليوم 4
    "رَمَضَاْنُ مِعْطَاْءٌ؛ يَنْفَعُ الْمُسْتَحِقِّيْنَ لِفِيُوْضِهِ الْسَّمْحَاْءِ! وَلَا يَأْبَهُ بِتَجَاْوُزِ الْتَّبْيِيْنِ الْمَبْنِيِّ عَلَىْ خَطَأِ أَوْ جَهْلِ تَقْرِيْرِ الْأنْبَاْءِ",  # اليوم 5
    "راءُ رَمَضَان: رَحْمَةُ الله للصَّائِمِين، وَالمِيمُ: مَغْفِرَتُهُ لِلمُؤَمِّنِينَ، وَالضَّادُ: ضَمَانُهُ لِجَزَاءِ الصَّائِمِينَ، وَالأَلْفُ: إِحْسَانُهُ للطَائِعين، والنونُ: نُورُه لِلمُحْسِنِينَ",  # اليوم 6
    "رَمَضَانُ رَسُوْلُ رَحْمَةٍ وَمَغْفِرَةٍ وعِتْقٍ لِلْبَرِيَّة! يَا أَيُّهَا الْمُؤْمِنُوْنَ! تَعَرَّضُوا لِفُيُوْضِ رَمَضَانَ القُدْسِيَّة، وتأَسُّوا بِهَا في الأخْلاقِ والمُعَامَلَةِ الاجْتِماعِيَّة",  # اليوم 7
    "التَّذْكِيْرُ مِنْ أَصَابِعِ أَيَادِي الرَّحْمَةِ لِلْعِبَادِ",  # اليوم 8
    "فَصْلُ رَحْمَةِ رَمَضَانَ يَسْتَدْعِيْ تَحْسِيْنَ الإِيْمَانِ",  # اليوم 9
    ...
    "ها قَد حَلَّ المَوْسِمُ الثاني لِرَمَضان، فَلْيُقْبِل بالتوْبة الظالِمُون لأنفُسِهم بالعِصْيان، فَقد تَجَلَّى رَبُّنا مُقْبِلا بالغُفْران",  # اليوم 11
    "فصل مغفرة رمضان يستدعي تحسين الإذعان",  # اليوم 12
    "الاسْتِغْفَارُ: يَشْتَمِلُ عَلَى الاعْتِذَارِ، وَطَلَبِ المَغْفِرَةِ مِنَ اللهِ العَفُوِّ الغَفَّارِ",  # اليوم 13
    ...
    "لا يزال الله يتجلَّى على البريَّة عمومًا وخصوصًا، من بدايةِ التَّكوينِ إلى أبدِ الآبدِيْن",  # اليوم 19
    ...
    "الفائدة التَّامة من ليلة القدر معقودة بحفظ الليالي العشر",  # اليوم 22
    ...
    "ها هو يَرتحل رَمَضان، وقد بَرَّه المُستجِيْبُون بالاجتماع والاجتِهاد في طاعة الرحمن، بينما عَقَّه الغافِلُون في اتِّباع الهَوَى والشيْطان. يا بُني! أنت معني بالمحسنين والمسيئين! فقُل: ربَّنا تقبّل من المطيعين، وتجاوز عن العاصين، وبارك لكُلِّ المؤمنين، برحمتك يا أرحم الراحمين",  # اليوم 29
